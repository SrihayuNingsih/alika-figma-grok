...
export function Hero() {
  ...
  return (
    <section id="home" className="relative h-screen w-full overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-20 flex h-full flex-col items-center justify-end px-4 pb-40 md:items-end md:justify-end md:px-8 md:pt-0">
        <div className="max-w-4xl text-left md:text-right">
          <p className="mb-2 text-xs tracking-widest text-gray-300 md:text-sm">
            LEARNING TRAVELING COOKING PHOTOGRAPHY
          </p>
          <h1 className="mb-4">
            <span className="mb-2 block text-4xl text-white md:text-7xl">
              welcome
            </span>
            <span className="block text-5xl font-bold text-orange-500 md:text-8xl">
              to My Blog
            </span>
          </h1>
          <p className="mb-4 max-w-2xl text-lg leading-relaxed text-white/90 md:text-xl">
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-8 left-1/2 z-20 mt-4 -translate-x-1/2 text-center">
      ...
      <div className="absolute right-8 bottom-8 z-20 hidden gap-4 md:flex">
        {[
