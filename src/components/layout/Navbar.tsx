...
export function Navbar() {
  ...
  return (
    <>
      {/* Navbar – z-index tinggi + padding aman di mobile */}
      <header
        className={cn(
      ...
      >
        <div className="mx-auto flex h-20 items-center justify-between px-4 md:px-8 lg:px-16">
          {/* Logo */}
          <button
          ...
          {/* Hamburger – Posisi aman di mobile */}
          <button
            className="md:hidden"
